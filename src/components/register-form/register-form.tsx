...
import RegisterRequest from '../../services/letrans-api/models/request/register.request';
import NotificationService from '../../services/notifictaion-service';
import { useTranslation } from 'react-i18next';
import UserContextType from '../../types/user-context.type';

const RegisterForm = () => {
    const [formData, setFormData] = useState<RegisterRequest>({ email: "", password: "", firstname: "", lastname: "" });
    ...
    return (
        <Box className={registerFormStyles.form}>
            ...
            <Grid container>
                <Grid item xs>
                    <Link href="#" variant="body2" onClick={() => history.push("/home")}>{t("component.register-form.home-redirect")}</Link>
                </Grid>
                <Grid item>
